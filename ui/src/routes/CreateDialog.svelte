<script lang="ts">
	...
	import { useCreateDocs } from '$lib/apidocs'
	...
	const createDocs = useCreateDocs()
	let dirName: string = "doc-name"
...
<button use:melt={$trigger} class="openbtn">New Doc</button>
...
{#if $open}
	<div use:melt={$portalled}>
		...
		<div use:melt={$content} class="content">
			...
			<input type="text" placeholder="title" class="w-full text-lg" bind:value={dirName} />
